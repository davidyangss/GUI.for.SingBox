export default {
  ...
  importClientConfig: {
    ...
    file: '文件路径',
    filePath: '文件路径',
    filePathPlaceholder: '例如 /path/to/client-config.json',
    pastePlaceholder: '请在下方粘贴 sing-box 客户端配置 JSON：',
    jsonPlaceholder: '在此粘贴完整的 sing-box 客户端配置 JSON...',
    invalidConfig: '无效的 JSON 配置',
    noOutbounds: '配置中未找到出站(outbounds)',
    noProxyOutbounds: '配置中未找到代理出站(vless, vmess, trojan 等)',
