export default {
  ...
  importClientConfig: {
    title: 'Import Client Config',
    inputMode: 'Input Mode',
    paste: 'Paste JSON',
    file: 'File Path',
    filePath: 'File Path',
    filePathPlaceholder: 'e.g. /path/to/client-config.json',
    pastePlaceholder: 'Paste the sing-box client configuration JSON below:',
    jsonPlaceholder: 'Paste full sing-box client config JSON here...',
    invalidConfig: 'Invalid JSON configuration',
    noOutbounds: 'No outbounds found in the configuration',
    noProxyOutbounds: 'No proxy outbounds (vless, vmess, trojan, etc.) found in the configuration',
    filePathRequired: 'File path is required',
    contentRequired: 'JSON content is required',
    success: 'Client config imported successfully',
  },
  profile: {
    name: 'Name',
